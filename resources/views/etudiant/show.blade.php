              ...
              <table class="table table-bordered second_td_noborder">
                <tbody>
                  ...
                  <tr>
                    <td> <b>{{ __('etudiant.cne') }}</b> </td>
                    <td>
                      <input id="cne" type="text" class="form-control" name="cne" value="@if($etudiant){{ $etudiant->cne }}@else{{ old('cne') }}@endif" maxlength="254" pattern=".{2,}"  required >
                      @if ($errors->has('cne'))
                        <span class="help-block">
